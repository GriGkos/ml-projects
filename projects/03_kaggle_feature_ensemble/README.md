...
4. При построении признаков и создании EDA-выборки читаются большие таблицы транзакций. Расчёт занимает примерно 45-60 минут на обычном ноутбуке и требует не менее 8 ГБ RAM.
