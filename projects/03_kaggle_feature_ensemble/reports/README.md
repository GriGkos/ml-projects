...
Перед финальной сдачей лучше убедиться, что на скриншоте текстом видны имя пользователя и публичный результат,
если это прямо требуется в условиях задания.
